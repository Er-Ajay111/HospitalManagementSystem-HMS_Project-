...
namespace HospitalManagementSystem_HMS_.AppApi.Migrations
{
    ...
    [Migration("20250612060146_navigationPropertyAdded")]
    partial class navigationPropertyAdded
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HospitalManagementSystem_HMS_.DB.Model.AppModel.AppointmentModel.PatientLabTests", b =>
                {
                    ...
                    b.HasOne("HospitalManagementSystem_HMS_.DB.Model.AuthModel.ApplicationUser", "OrderedBy")
                        .WithMany()
